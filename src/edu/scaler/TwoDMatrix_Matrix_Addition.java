...
public class TwoDMatrix_Matrix_Addition {

    public static void main(String[] args) {
        TwoDMatrix_Matrix_Addition object = new TwoDMatrix_Matrix_Addition();
        ...
        ArrayList<ArrayList<Integer>> result = object.addMatrices(A, B);
     ...
     * @return VECTOR OF VECTOR OF INTEGERS AFTER SUM
     * 
     * TC : O(N^2)
     * SC : O(N^2+N)
     */
    private ArrayList<ArrayList<Integer>> addMatrices(
